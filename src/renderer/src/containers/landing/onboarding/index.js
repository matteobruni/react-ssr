...
import {
  ...
  Facebook2,
  // Apple,
  logoDark, Stars1, Stars2, Stars3, Stars4,
} from "../../../assets";
import {
  showSnackbar,
  loadingWrapper,
...
const OnBoarding = ({ isOpen, handleClose }) => {
  ...
  useEffect(() => {
    if (processStarted) {
      navigator && navigator.vibrate && navigator.vibrate(10);
    }
  }, [activeTab]);
    ...
    >
      ...
      >
        ...
        <div className="slide__page">
          <div className="first__page__inner">
            <div className="top__area">
              <button onClick={handleSliderClose}>
                <CancelIcon />
              </button>
            </div>
          ...
          <div className="slide__page">
            <div className="second__page__inner">
              <div className="top__area">
                ...
                {allowNext && (
                  <button
                    onClick={() => setTimeout(() => setActiveTab(2), 250)}
                  >
                    <ArrowForwardIcon />
                  </button>
                )}
              ...
              <div
                className={otpError ? "otp__input otp__error" : "otp__input"}
              >
                {phoneExists && (
        ...
        {phoneRoute ? (
          ...
          <div className="slide__page">
            <div
              className={`second__page__inner ${
                !phoneRoute && isOpen && "slideInLeft"
              }`}
            >
              <div className="top__area">
                <div>
        ...
        <div className="slide__page">
          <div className="fourth__page__inner">
            ...
            <div className="stars__background index">
              <img src={Stars1} alt=""/>
              <img src={Stars2} alt=""/>
              <img src={Stars3} alt=""/>
              <img src={Stars4} alt=""/>
            ...
            <div className="select__classes">
              {getAvailableGrades(null, true).map(({ planet, grade, value }) => (
                <div onClick={() => setUserGrade(value)} className={"class__item" + (activeUserGrade === value ? ' active' : activeUserGrade ? ' not-active' : '')} key={value}>
